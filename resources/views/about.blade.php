...
@section('content')
    ...
    <br><br>
    <!-- Section: boxes -->
    <section id="about" class="home-section paddingtop-100">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-3 col-md-3">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box text-center">
                            ...
                            <i class="fa fa-eye fa-3x circled bg-skin"></i>
                            <h4 class="h-bold">Vision</h4>
                            <p>
                                Vision Statment
                            </p>
                        </div>
                ...
                <div class="col-sm-3 col-md-3">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box text-center">
                            ...
                            <i class="fa fa-bullseye fa-3x circled bg-skin"></i>
                            <h4 class="h-bold">Mission Statment</h4>
                            <p>
                                NNAK's mission statement goes here
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 col-md-3">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box text-center">
                            <i class="fa fa-list-ol fa-3x circled bg-skin"></i>
                            <h4 class="h-bold">Values</h4>
                            <p>
                                Brief statement about your value.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 col-md-3">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <div class="box text-center">
                            ...
                            <h4 class="h-bold">Other</h4>
                            <p>
                                Any other item you could wish to include here
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <section id="statement" class="home-section paddingtop-40">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
